...
public class Match {
    ...
    public void begin(Player player) {
        ...
        while (true) {
            ...
            if (player.getPlayerHand().isBlackJack() && dealer.getDealerHand().isBlackJack()) {
                ...
                {
                    System.out.println("\n===============Dealer wins!============");
                    break; //This should happen in player.playPlayer, but how?
                }
    ...
    public static void printState(Player player, Dealer dealer, String first) {
        if (first.equals("y")) {
            System.out.println("=================================================================");
            System.out.println(player);
            System.out.println("DEALER: " + dealer.getDealerHand().getHand().get(0) + "    UNKNOWN");
            System.out.println("=================================================================");
        } else {
            System.out.println("=================================================================");
            System.out.println(player);
